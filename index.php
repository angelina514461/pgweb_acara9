...
<html>
    ...
    <nav class="navbar" style="background-color: #ece2f0;">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="icon/map.png" alt="Logo" width="30" height="24" class="d-inline-block align-text-top">
                WebGIS Sleman
            </a>
            <a class="btn btn-success" href="http://localhost/pgweb_acara8/index.html" role="button">Input</a>
        </div>
    </nav>
